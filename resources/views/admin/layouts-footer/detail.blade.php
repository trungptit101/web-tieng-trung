            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card card-success card-outline">
                        <form action="{{ route('footer.update', $footer->id) }}" method="post" id="formRegisterCoach" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea placeholder="Tiêu đề" id="title" class="form-control title @error(" title") is-invalid @enderror" name="title">{{ $footer->title }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="" class="col-sm-2 col-form-label">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea placeholder="Mô tả tài liệu" id="description" class="form-control ckeditor description @error(" description") is-invalid @enderror" name="description">{{ $footer->description }}</textarea>
                                        @error("description")
