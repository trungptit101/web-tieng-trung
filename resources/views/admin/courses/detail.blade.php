            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active">Cập nhật thông tin khoá học</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card card-success card-outline">
                        ...
                        <form class="form-horizontal" enctype="multipart/form-data" method="post" id="courseForm" action="{{ route('courses.update', $course->id) }}">
                            <div class="card-body">
                                @csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input placeholder="Tiêu đề" id="title" value="{{ $course->title }}" class="form-control title @error(" title") is-invalid @enderror" name="title" />
                                        @error("title")
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea placeholder="Thông tin khoá học" id="infomationCourse" class="form-control ckeditor infomationCourse @error(" infomationCourse") is-invalid @enderror" name="infomationCourse">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea placeholder="Đầu ra khoá học" id="outputCourse" class="form-control ckeditor outputCourse @error(" outputCourse") is-invalid @enderror" name="outputCourse">
                                        {{ $course->outputCourse }}
                                        </textarea>
                                        @error("outputCourse")
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea placeholder="Quyền lợi học viên" id="interestCourse" class="form-control ckeditor interestCourse @error(" interestCourse") is-invalid @enderror" name="interestCourse">
                                ...
                                <div class="row">
                                    ...
                                    <div class="resource-list col-sm-10" id="resource-list">
                                        @if($course->resources)
                                        @foreach(json_decode($course->resources) as $resource)
